...
with pm.Model(coords=coords) as obesity_model:
    ...
    #whq070 = pm.Data("whq070", X_train["WHQ070"].values, dims="seqn_id") # 1 represents intentional weight loss; this has been commended out because it is believed to be a collider
    ...
    #beta_whq070 = pm.Beta("beta_whq070", alpha=1, beta=2) # Intentional weight loss should correspond with lower probability of obesity; this has been commended out because it is believed to be a collider
...
with obesity_model:
    pm.set_data({
        ...
        #"whq070": X_test["WHQ070"].values, (collider)
